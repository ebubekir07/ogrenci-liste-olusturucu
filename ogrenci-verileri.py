...
devam = dvm.cursor()
cursor = con.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS ogrenciler(no INT,ad TEXT,soyad TEXT,sinif INT,sube TEXT,tc INT,tel INT,mail TEXT,ay TEXT,gun INT,yil INT,bolum TEXT,il TEXT,ilce TEXT)")
...
def eokul():
    ...
    yil=mailveri[2]
    tc=mailveri[3]
    sinifsube=mailveri[4]
    getiralan=mailveri[5]
    il=mailveri[6]
    ilce=mailveri[7]
    ...
    try:
        ...
        vg.click()
        time.sleep(1)
        tck=browser.find_element_by_name("textinput2")
        okulnumarasi=browser.find_element_by_name("textinput3")
        ...
        while (key==1):
            ...
            if len(kodd)==4:
                girisyap=browser.find_element_by_id("btnVBSGiris")
                girisyap.click()
                time.sleep(0.2)
                try:
                    pardon=browser.find_element_by_css_selector("body > div.swal-overlay.swal-overlay--show-modal > div > div.swal-footer > div > button")
                    pardon.click()
                except:
                    print("kod doğru")
                    key=0
        try:
            soru1=browser.find_element_by_id("lblS1C1").text
        except:
            soru1=browser.find_element_by_id("lblS1T1").text
        try:
            soru2=browser.find_element_by_id("lblS2C1").text
        except:
            soru2=browser.find_element_by_id("lblS2T1").text

        if soru1=="Öğrencinin doğum günü hangisidir?":
            print("soru1=","doğum gün")
            cevap1=Select(browser.find_element_by_id("ddlS1C1"))
            cevap1.select_by_index(gun)
        elif soru1=="Öğrencinin doğum yılı nedir?":
            print("soru1=","doğum yıl")
            yils=browser.find_element_by_id("txtS1T1")
            yils.send_keys(yil)
        elif soru1=="Öğrencinin doğum ayı hangisidir?":
            print("soru1=","doğum ayı")
            cevap1=Select(browser.find_element_by_id("ddlS1C1"))
            cevap1.select_by_visible_text(ay)
        elif soru1=="Öğrencinin nüfusa kayıtlı olduğu ilçe hangisidir?":
            print("soru1=","ilçe")
            cevap1=Select(browser.find_element_by_id("ddlS1C1"))
            cevap1.select_by_visible_text(ilce)
        elif soru1=="Öğrencinin nüfusa kayıtlı olduğu il hangisidir?":
            print("soru1=","il")
            cevap1=Select(browser.find_element_by_id("ddlS1C1"))
            cevap1.select_by_visible_text(il)
        elif soru1=="Öğrencinin okuduğu şube hangisidir?":
            print("soru1=","şube")
            cevap1=Select(browser.find_element_by_id("ddlS1C1"))
            cevap1.select_by_visible_text(sube)


        if soru2=="Öğrencinin doğum günü hangisidir?":
            print("soru2=","doğum gün")
            cevap2=Select(browser.find_element_by_id("ddlS2C1"))
            cevap2.select_by_index(gun)
        elif soru2=="Öğrencinin doğum yılı nedir?":
            print("soru2=","doğum yıl")
            cevap2=browser.find_element_by_name("txtS2T1")
            cevap2.send_keys(yil)
        elif soru2=="Öğrencinin doğum ayı hangisidir?":
            print("soru2=","doğum ayı")
            cevap2=Select(browser.find_element_by_id("ddlS2C1"))
            cevap2.select_by_visible_text(ay)
        elif soru2=="Öğrencinin nüfusa kayıtlı olduğu ilçe hangisidir?":
            print("soru2=","ilçe")
            cevap2=Select(browser.find_element_by_id("ddlS2C1"))
            cevap2.select_by_visible_text(ilce)
        elif soru2=="Öğrencinin nüfusa kayıtlı olduğu il hangisidir?":
            print("soru2=","il")
            cevap2=Select(browser.find_element_by_id("ddlS2C1"))
            cevap2.select_by_visible_text(il)
        elif soru2=="Öğrencinin okuduğu şube hangisidir?":
            print("soru2=","şube")
            cevap2=Select(browser.find_element_by_id("ddlS2C1"))
        ...
        while(anahtar==1):
            ...
            resim2 = browser.find_element_by_id("rdRes2").get_attribute("checked")
            ...
            if resim2 is not None:
                anahtar=0
            if resim3 is not None:
                anahtar=0
            if resim4 is not None:
                anahtar=0
            if resim5 is not None:
                anahtar=0
        btnTamam=browser.find_element_by_name("btnTamam")
        btnTamam.click()
        browser.get("https://eokulyd.meb.gov.tr/IlkOgretim/Veli/IOV02002.aspx")
        time.sleep(1)
        if getiralan=="MF":
            abeden=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(3) > td.header4").text
            adin=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(4) > td.header4").text
            afelsefe=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(5) > td.header4").text
            amuzik=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(6) > td.header4").text
            aalmanca=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(7) > td.header4").text
            abiyoloji=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(8) > td.header4").text
            afizik=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(9) > td.header4").text
            akimya=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(10) > td.header4").text
            amatematik=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(11) > td.header4").text
            atarih=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(12) > td.header4").text
            aedebiyat=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(13) > td.header4").text
            aingilizce=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(14) > td.header4").text
            
            biyoloji=float(abiyoloji.replace(",","."))
            fizik=float(afizik.replace(",","."))
            kimya=float(akimya.replace(",","."))
            ...
            if kimya>0:
                cursor.execute("UPDATE chek SET ckimya = '1' WHERE no = {}".format(eokulno))
            if beden>0:
            ...
            cursor.execute("UPDATE dersler SET biyo = '{}' WHERE no = {}".format(biyoloji,eokulno))
            cursor.execute("UPDATE dersler SET edeb = '{}' WHERE no = {}".format(edebiyat,eokulno))
            cursor.execute("UPDATE dersler SET tarih = '{}' WHERE no = {}".format(tarih,eokulno))
            cursor.execute("UPDATE dersler SET fel = '{}' WHERE no = {}".format(felsefe,eokulno))
            cursor.execute("UPDATE dersler SET din = '{}' WHERE no = {}".format(din,eokulno))
            cursor.execute("UPDATE dersler SET ing = '{}' WHERE no = {}".format(ingilizce,eokulno))
            cursor.execute("UPDATE dersler SET beden = '{}' WHERE no = {}".format(beden,eokulno))
            ...
            amuzik=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(6) > td.header4").text
            aalmanca=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(7) > td.header4").text
            acografya=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(8) > td.header4").text
            amatematik=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(9) > td.header4").text
            apsikoloji=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(10) > td.header4").text
            asecedebiyat=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(11) > td.header4").text
            atkmt=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(12) > td.header4").text
            atarih=browser.find_element_by_css_selector("#Table3 > tbody > tr:nth-child(13) > td.header4").text
            ...
            cursor.execute("UPDATE dersler SET mat = '{}' WHERE no = {}".format(matematik, eokulno))
            cursor.execute("UPDATE dersler SET cog = '{}' WHERE no = {}".format(cografya, eokulno))
            cursor.execute("UPDATE dersler SET secedb = '{}' WHERE no = {}".format(secedebiyat, eokulno))
            cursor.execute("UPDATE dersler SET edeb = '{}' WHERE no = {}".format(edebiyat,eokulno))
            cursor.execute("UPDATE dersler SET tarih = '{}' WHERE no = {}".format(tarih,eokulno))
            cursor.execute("UPDATE dersler SET fel = '{}' WHERE no = {}".format(felsefe,eokulno))
            cursor.execute("UPDATE dersler SET din = '{}' WHERE no = {}".format(din,eokulno))
...
def kisiekleme(gelenkomut):
    ...
    no=int(oknoen.get())
    sube=str(subeen.get()).replace("i","İ").upper()
    tc=int(tcen.get())
    tel=int(telen.get())
    ...
    bolum=str(alan.get())
    il=str(ilen.get()).replace("i","İ").upper()
...
def sifredogru():
    ...
    pencere = Tk()
    pencere.title("Öğrenci Verileri v3.2")
    ...
    def kisisil():
        ...
        if (kontrol1[0]==0):
            ...
            devam.execute("DROP TABLE '{}'".format(silinecek))
            dvm.commit()
            con.commit()
            listele()
    def verial():  
    ...
    if(mevcut>0):
        listele()
    aylar = ['OCAK  ', 'ŞUBAT', 'MART', 'NİSAN','MAYIS', 'HAZİRAN',"TEMMUZ","AĞUSTOS",
    ...
    drivervar = StringVar(pencere,value="C:\Program Files\chromedriver.exe")
    ...
    ecizgi=Label(pencere,text="___________________________________",width=27)
    ecizgi.place(relx=0.43,rely=0.53)
    #-------------------------------------------------
    ...
    eokullab = Label(pencere,text="Okul No:",width=10,anchor="w")
    eokullab.place(relx=0.46,rely=0.61)
    eokulen = Entry(pencere,width=10)
    eokulen.place(relx=0.54,rely=0.61)
    eokulbut = Button(pencere,text="Tamam",command=eokul,width=6).place(relx=0.55,rely=0.65)
    #--------------------------------------------------------
